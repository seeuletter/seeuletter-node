...
(function () {
  ...
  this.create = function (params, callback) {
    ...
    params.source_file_2 = tmp_source_file_2
    params.source_file_3 = tmp_source_file_3
    params.source_file_4 = tmp_source_file_4
    params.source_file_5 = tmp_source_file_5
